...
msigdb_cART_EC_tous.cART_untreat.ID.Ratio <- dplyr::bind_rows(msigdb_cART_EC_tous.cART_untreat_avoir, msigdb_cART_EC_tous.cART_untreat_sans) %>% dplyr::rename(cART_untreat = Ratio)
...
msigdb_cART_EC_tous.cART_long.ID.Ratio <- dplyr::bind_rows(msigdb_cART_EC_tous.cART_long_avoir, msigdb_cART_EC_tous.cART_long_sans) %>% dplyr::rename(cART_short = Ratio)
...
msigdb_cART_EC_tous.cART_short.ID.Ratio <- dplyr::bind_rows(msigdb_cART_EC_tous.cART_short_avoir, msigdb_cART_EC_tous.cART_short_sans) %>% dplyr::rename(cART_long = Ratio)
...
msigdb_cART_EC_tous.EC_long.ID.Ratio <- dplyr::bind_rows(msigdb_cART_EC_tous.EC_long_avoir, msigdb_cART_EC_tous.EC_long_sans) %>% dplyr::rename(EC_long = Ratio)

msigdb_cART_EC_tous.ID.Ratio <- dplyr::bind_cols(msigdb_cART_EC_tous.cART_untreat.ID.Ratio, msigdb_cART_EC_tous.cART_long.ID.Ratio, msigdb_cART_EC_tous.cART_short.ID.Ratio, msigdb_cART_EC_tous.EC_long.ID.Ratio) %>% dplyr::select(ID...1, cART_untreat, cART_short, cART_long, EC_long)
...
pdf("/media/chen/DATA/evoPath/Abb/msigdb_cART_EC_evolution_pathway.pdf")  
Heatmap(msigdb_cART_EC_tous.ID.Ratio.mx, name = "GeneRatio/BgRatio", rect_gp = gpar(col = "white", lwd = 0.5), column_title = "clinical condition", row_title = "C7: immunologic signatures", column_title_side = "bottom", row_dend_width = unit(4, "cm"), row_names_gp = gpar(fontsize = 10), column_names_gp = gpar(fontsize = 10), row_km = 5)
dev.off()
